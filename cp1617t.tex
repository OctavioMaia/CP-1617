...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inv}\;\Varid{x}\mathrel{=}\p1\comp \mathsf{for}\ \conj{\uncurry{(\mathbin{+})}}{((\mathrm{1}\mathbin{-}\Varid{x})\mathbin{*})\comp \p2}\ (\mathrm{1},\mathrm{1}\mathbin{-}\Varid{x}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{genDouble}\mathbin{::}\Conid{Gen}\;(\Conid{Double}){}\<[E]%
\\
\>[B]{}\Varid{genDouble}\mathrel{=}\Varid{\Conid{Test}.\Conid{QuickCheck}.choose}\;(\mathrm{1.0},\mathrm{2.0}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{testProb1}\;\Varid{n}\mathrel{=}\Varid{quickCheck}\mathbin{\$}\Varid{forAll}\;\Varid{genDouble}\;\Varid{check}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{check}\mathrel{=}\lambda \Varid{x}\to (\Varid{abs}\;((\mathrm{1}\mathbin{/}\Varid{x})\mathbin{-}(\Varid{inv}\;\Varid{x}\;\Varid{n}\mathbin{+}\mathrm{1})))\mathbin{>}\Varid{abs}\;((\mathrm{1}\mathbin{/}\Varid{x})\mathbin{-}(\Varid{inv}\;\Varid{x}\;\Varid{n})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{worker}\mathrel{=}\Varid{cataList}\mathbin{\$}\alt{\Varid{a}}{\Varid{b}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{a}\mathrel{=}\conj{\Varid{true}}{{}\<[31]%
\>[31]{}\underline{\mathrm{0}}}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{b}\mathrel{=}\conj{\Varid{sep}\comp \p1}{\Varid{cond}\;(\uncurry{(\mathrel{\wedge})}\comp (\neg \comp \Varid{sep}\times\p1))\;(\succ \comp \p2\comp \p2)\;(\p2\comp \p2)}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{sep}\;\Varid{c}\mathrel{=}{}\<[21]%
\>[21]{}\Varid{c}\equiv \text{\tt '~'}\mathrel{\vee}\Varid{c}\equiv \text{\tt '\char92 n'}{}\<[44]%
\>[44]{}\mathrel{\vee}\Varid{c}\equiv \text{\tt '\char92 t'}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{check}\;\Varid{s}\mathrel{=}\Varid{toInteger}\;(\Varid{wc\char95 w}\;\Varid{s})\equiv \Varid{toInteger}\;(\Varid{wc\char95 w\char95 final}\;\Varid{s}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{testProb2}\mathrel{=}\Varid{quickCheck}\;\Varid{check}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{outB\char95 tree}\;(\Conid{Block}\;\Varid{a}\;\Varid{b})\mathrel{=}i_2\;(\Varid{a},\Varid{b}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{cataB\char95 tree}\;\Varid{g}\mathrel{=}\Varid{g}\comp (\Varid{recB\char95 tree}\;(\Varid{cataB\char95 tree}\;\Varid{g}))\comp \Varid{outB\char95 tree}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaB\char95 tree}\;\Varid{g}\mathrel{=}\Varid{inB\char95 tree}\comp (\Varid{recB\char95 tree}\;(\Varid{anaB\char95 tree}\;\Varid{g}))\comp \Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloB\char95 tree}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{cataB\char95 tree}\;\Varid{f}\comp \Varid{anaB\char95 tree}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{instance}\;\Conid{Functor}\;\mathsf{B}\mbox{-}\mathsf{tree} {}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\mathsf{fmap}\;\Varid{f}\mathrel{=}\Varid{cataB\char95 tree}\;(\Varid{inB\char95 tree}\comp \Varid{baseB\char95 tree}\;\Varid{f}\;\Varid{id}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inordB\char95 tree}\mathrel{=}\Varid{cataB\char95 tree}\;\Varid{inordB}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inordB}\mathrel{=}\alt{\Varid{nil}}{\Varid{join}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{join}\mathrel{=}\mathsf{conc}\comp (\Varid{id}\times(\Varid{foldr}\;(\plus )\;[\mskip1.5mu \mskip1.5mu])\comp (\map \;\Varid{cons})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{largestBlock}\mathrel{=}\Varid{cataB\char95 tree}\;\Varid{largestBlockAux}{}\<[E]%
\\
\>[B]{}\Varid{largestBlockAux}\mathrel{=}\alt{\underline{\mathrm{0}}}{\Varid{largest}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{largest}\;(\Varid{x},\Varid{xs})\mathrel{=}\Varid{max}\;\Varid{x}\;(\Varid{max}\;(\length \;\Varid{xs})\;(\Varid{maximum}\;(\p2\;(\Varid{unzip}\;\Varid{xs})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{mirrorB\char95 tree}\mathrel{=}\Varid{anaB\char95 tree}\;((\Varid{id}+\Varid{mirrorB\char95 treeAux})\comp \Varid{outB\char95 tree}){}\<[E]%
\\
\>[B]{}\Varid{mirrorB\char95 treeAux}\;(\Varid{x},\Varid{xs})\mathrel{=}(\p2\;(\Varid{last}\;\Varid{xs}),\Varid{reverse}\;(\Varid{mirrorAux}\;(\Varid{x},\Varid{reverse}\;\uncurry{\Varid{zip}}\;((\Varid{reverse}\times\Varid{id})\;(\Varid{unzip}\;\Varid{xs}))))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{mirrorAux}\;(\Varid{x},(\Varid{a},\Varid{b})\mathbin{:}\Varid{xs})\mathrel{=}(\Varid{a},\Varid{x})\mathbin{:}\Varid{xs}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lsplitB\char95 tree}\;[\mskip1.5mu \mskip1.5mu]{}\<[20]%
\>[20]{}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{lsplitB\char95 tree}\;[\mskip1.5mu \Varid{h}\mskip1.5mu]{}\<[20]%
\>[20]{}\mathrel{=}i_2\;([\mskip1.5mu \mskip1.5mu],[\mskip1.5mu (\Varid{h},[\mskip1.5mu \mskip1.5mu])\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{lsplitB\char95 tree}\;(\Varid{x}\mathbin{:}\Varid{y}\mathbin{:}\Varid{t}){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{x}\mathbin{>}\Varid{y}{}\<[24]%
\>[24]{}\mathrel{=}\mathbf{let}\;(\Varid{l1},\Varid{l2},\Varid{l3})\mathrel{=}\Varid{splitB\char95 tree}\;(\uncurry{(\mathrel{\wedge})}\comp \conj{\mathbin{>}\Varid{y}}{\mathbin{<}\Varid{x}})\;(\mathbin{>}\Varid{y})\;\Varid{t}\;\mathbf{in}\;i_2\;(\Varid{l1},(\Varid{y},\Varid{l2})\mathbin{:}[\mskip1.5mu (\Varid{x},\Varid{l3})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{otherwise}\mathrel{=}\mathbf{let}\;(\Varid{l1},\Varid{l2},\Varid{l3})\mathrel{=}\Varid{splitB\char95 tree}\;(\uncurry{(\mathrel{\wedge})}\comp \conj{\mathbin{>}\Varid{x}}{\mathbin{<}\Varid{y}})\;(\mathbin{>}\Varid{x})\;\Varid{t}\;\mathbf{in}\;i_2\;(\Varid{l1},(\Varid{x},\Varid{l2})\mathbin{:}[\mskip1.5mu (\Varid{y},\Varid{l3})\mskip1.5mu]){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{splitB\char95 tree}\mathbin{::}(\Varid{a}\to \Conid{Bool})\to (\Varid{a}\to \Conid{Bool})\to [\mskip1.5mu \Varid{a}\mskip1.5mu]\to ([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{splitB\char95 tree}\;\p1\;\p2\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}([\mskip1.5mu \mskip1.5mu],[\mskip1.5mu \mskip1.5mu],[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{splitB\char95 tree}\;\p1\;\p2\;(\Varid{h}\mathbin{:}\Varid{t}){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \p1\;\Varid{h}{}\<[25]%
\>[25]{}\mathrel{=}\mathbf{let}\;(\Varid{s},\Varid{m},\Varid{l})\mathrel{=}\Varid{splitB\char95 tree}\;\p1\;\p2\;\Varid{t}\;\mathbf{in}\;(\Varid{s},\Varid{h}\mathbin{:}\Varid{m},\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \p2\;\Varid{h}{}\<[25]%
\>[25]{}\mathrel{=}\mathbf{let}\;(\Varid{s},\Varid{m},\Varid{l})\mathrel{=}\Varid{splitB\char95 tree}\;\p1\;\p2\;\Varid{t}\;\mathbf{in}\;(\Varid{s},\Varid{m},\Varid{h}\mathbin{:}\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{otherwise}\mathrel{=}\mathbf{let}\;(\Varid{s},\Varid{m},\Varid{l})\mathrel{=}\Varid{splitB\char95 tree}\;\p1\;\p2\;\Varid{t}\;\mathbf{in}\;(\Varid{h}\mathbin{:}\Varid{s},\Varid{m},\Varid{l}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{qSortB\char95 tree}\mathrel{=}\Varid{hyloB\char95 tree}\;\Varid{inordB}\;\Varid{lsplitB\char95 tree}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{cB\char95 tree2Exp}\mathrel{=}\Varid{cataB\char95 tree}\mathbin{\$}\alt{\Varid{nul}}{\Varid{rest}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{nul}{}\<[14]%
\>[14]{}\mathrel{=}\underline{(\Conid{Var}\;\text{\tt \char34 nil\char34})}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{rest}\mathrel{=}\uncurry{\Conid{Term}}\comp \conj{(\map \;\p1)\comp \p2}{\Varid{cons}\comp \conj{\p1}{(\map \;\p2)\comp \p2}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{generateAlgae}\mathrel{=}\ana{\Varid{ga}~\Varid{gb}}_A{}\<[E]%
\\
\>[B]{}\Varid{ga}\;\mathrm{0}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{ga}\;\Varid{n}\mathrel{=}i_2\;(\Varid{n}\mathbin{-}\mathrm{1},\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{gb}\;\mathrm{0}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{gb}\;\Varid{n}\mathrel{=}i_2\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{showAlgae}\mathrel{=}\cata{\Varid{l}~\Varid{r}}_A{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{l}\mathrel{=}\alt{\underline{\text{\tt \char34 A\char34}}}{\mathsf{conc}}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{r}\mathrel{=}\alt{\underline{\text{\tt \char34 B\char34}}}{\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{genInt}\mathbin{::}\Conid{Gen}\;(\Conid{Int}){}\<[E]%
\\
\>[B]{}\Varid{genInt}\mathrel{=}\Varid{\Conid{Test}.\Conid{QuickCheck}.choose}\;(\mathrm{0},\mathrm{10}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{checkAlgae}\;\Varid{n}\mathrel{=}\Varid{a}\equiv \Varid{f}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{a}\mathrel{=}\Varid{toInteger}\mathbin{\$}\length \;(\Varid{showAlgae}\;(\Varid{generateAlgae}\;\Varid{n})){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{f}\mathrel{=}\Varid{fib}\mathbin{\$}\Varid{toInteger}\;(\succ \;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{testProb4}\mathrel{=}\Varid{quickCheck}\mathbin{\$}\Varid{forAll}\;\Varid{genInt}\;\Varid{checkAlgae}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}(\Varid{h},\Varid{t})\leftarrow \Varid{getR}\;\Varid{l};{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{x}\leftarrow \Varid{permuta}\;\Varid{t};{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{return}\;(\Varid{h}\mathbin{:}\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mskip1.5mu\}{}\<[E]%
\ColumnHook
...
\column{27}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{eliminatoria}\;(\Conid{Leaf}\;\Varid{x})\mathrel{=}\Varid{return}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{eliminatoria}\;(\Conid{Fork}\;(\Varid{x},\Varid{y}))\mathrel{=}\mathbf{do}\;\{\mskip1.5mu {}\<[E]%
\\
\>[B]{}\hsindent{27}{}\<[27]%
\>[27]{}\Varid{v}\leftarrow \Varid{eliminatoria}\;\Varid{x};{}\<[E]%
\\
\>[B]{}\hsindent{27}{}\<[27]%
\>[27]{}\Varid{z}\leftarrow \Varid{eliminatoria}\;\Varid{y};{}\<[E]%
\\
\>[B]{}\hsindent{27}{}\<[27]%
\>[27]{}\Varid{jogo}\;(\Varid{v},\Varid{z}){}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\mskip1.5mu\}{}\<[25E]%
\\[\blanklineskip]%
\>[B]{}\Varid{listaEquipas}\mathrel{=}\Conid{Fork}\;({}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Conid{Fork}\;({}\<[E]%
\\
...
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Conid{Fork}\;(\Conid{Leaf}\;(\text{\tt \char34 Sporting\char34}),\Conid{Leaf}\;(\text{\tt \char34 Chaves\char34})),{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Conid{Fork}\;(\Conid{Leaf}\;(\text{\tt \char34 P.Ferreira\char34}),\Conid{Leaf}\;(\text{\tt \char34 Benfica\char34})){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}){}\<[E]%
\\
...
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Conid{Fork}\;(\Conid{Leaf}\;(\text{\tt \char34 Porto\char34}),\Conid{Leaf}\;(\text{\tt \char34 Braga\char34})),{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Conid{Fork}\;(\Conid{Leaf}\;(\text{\tt \char34 Setubal\char34}),\Conid{Leaf}\;(\text{\tt \char34 Feirense\char34})){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}){}\<[E]%
\\
...
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Conid{Fork}\;(\Conid{Leaf}\;(\text{\tt \char34 Guimaraes\char34}),\Conid{Leaf}\;(\text{\tt \char34 Belenenses\char34})),{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Conid{Fork}\;(\Conid{Leaf}\;(\text{\tt \char34 Moreirense\char34}),\Conid{Leaf}\;(\text{\tt \char34 Maritimo\char34})){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}){}\<[E]%
\\
...
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Conid{Fork}\;(\Conid{Leaf}\;(\text{\tt \char34 Arouca\char34}),\Conid{Leaf}\;(\text{\tt \char34 Estoril\char34})),{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Conid{Fork}\;(\Conid{Leaf}\;(\text{\tt \char34 Rio~Ave\char34}),\Conid{Leaf}\;(\text{\tt \char34 Nacional\char34})){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}){}\<[E]%
\\
